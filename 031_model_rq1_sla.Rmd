...
biotic_vars <- c("dom_seedling_cover", "overall_seedling_cover", "dom_species_id", "sla_character_range", "sla_species_niche_space", "sla_functional_richness")
...
inla_formula <- as.formula("dom_sla_weighted_abundance ~ site + dom_species_id + scaled_dom_seedling_cover + scaled_av_trans_elevation +  dom_species_id:scaled_av_trans_elevation +  f(transect, model='iid') + f(quadrat:transect, model = 'iid')")
