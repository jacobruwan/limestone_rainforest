...
#### Variation Breakdown
In the figure below, we observe a different outcome than expected. Large variation was observed between quadrats for weighted SLA, however the INLA model shows that miminal variation was attributed to the random effects.
