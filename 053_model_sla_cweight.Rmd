...
inla_formula <- as.formula("log(sla_cw) ~  site + dom_species_id + site:dom_species_id + scaled_av_quad_lai + scaled_av_quad_lai^2 + scaled_av_quad_lai:dom_species_id + f(transect, model='iid') + f(quadrat:transect, model = 'iid')")
...
# RUn a model on the top 3 variables identified
inla_formula <- as.formula("log(sla_cw) ~  site + dom_species_id + site:dom_species_id + scaled_av_quad_lai +  scaled_av_quad_lai:dom_species_id + f(transect, model='iid') + f(quadrat:transect, model = 'iid')")
