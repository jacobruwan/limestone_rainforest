...
### RICKY SPECIES RICHNESS SUMMARY
...
In examining the effects of disturbance on the temperature, it was found that disturbance implied for higher temperature. A disturbed area was more likely to have high temperatures as oppose to cooler temperatures.

While the Shannon's Index of Diversity is not dependent on the disturbance, it appears to be dependent on other variables such as higher seedling cover, GFT, and leaf dry weight. These variables all imply for a higher diversity index. 
...
The implications of our findings show that the disturbance of the limestone rainforests in Langkawi Island affects the several important attributes. The understanding of the dominant seedling species predicts the future of the forest, and therefore the negative impacts of seedling species will reflect in the future. Brief limitations are attached as an appendix (Appendix 2).
