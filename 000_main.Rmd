...
packages_to_load <- c("readxl", "dplyr", "tidyr", "magrittr", "knitr",
                      ...
                      "lme4", "INLA", "stringr", "scales", "splines", "car")
...
Due to the scope of this project it was decided to focus on the understory of the rainforest. This was for multiple logistic reasons and findings in past literature. This did not limit the study as the understory of rainforests have been shown to be incredibly important with particular variables being good predictors. Understories have continuously been used to investigate disturbed forests. One example looked at different forest understories in the Philippines, a main finding being higher species richness in the disturbed (Wills et al., 2016). 
...
In previous studies, the plant cover of a specific species is an indicator to the nutriants stored in the soil; this is because the cover contributes to the governance of soil erosion (Pohl, Graf, Buttler, & Rixen, 2012). In addition, it was proven in other forest types that the combined contribution of seedling cover and high species richness is significantly more effective at governing soil erosion (Pohl et al., 2012).  Disturbance implies for the presence of species that are more resilient to the lack of necessary nutrients, and thereby affecting the level of seedling cover in an area (Funk,2008). For example, a fire can burn up to the entire understorey; which promotes the growth of pioneer species that disperse and grow quicker in disturbed forests (Fourrier et al., 2015). These species typically need high photosynthetic rate, growth capacity, and nutrient storage to recover from recent disturbances (Manninen, Stark, Kytöviita, Lampinen, & Tolvanen, 2009). The different types of disturbances can affect how the plants grow, and therefore may contribute to the changes in seedling cover.
...
Other studies suggested that increased disturbance leads to high diversities due to advantageous/fast growing species (Nguyen et al., 2012). One particular study also focussed on only dominant species and found their diversity was a good indicator of disturbance (Stevens et al., 2015). This was reiterated in an understory study on ecosystem functions in forests of varying soil types, elevation and weather conditions (Duguid et al., 2013). 
...
## Model Outcomes
The variables remaining through the model fit procedure were the abundance of dominant species and their species identification; disturbance did not appear likely to be a significant variable to the seedling cover of dominent species. However, the results of the regression demonstrated that each species contributes differently to the seedling cover; the presence of dominant species 2 implied that there was relatively higher seedling cover compared to dominant species 1 and 3. Furthermore, the regression showed that the abundance of dominent species has a positive effect on the seedling cover. 
...
## Model Outcomes
There was no difference between sites, with higher variation in the disturbed transects. This follows a suggestion that arose that disturbed areas are more adaptive to the conditions. We saw relationships between the overall seedling cover, total dominant leaf dry weight, average quadrat Gap Fraction Threshold and the interaction between site and overall seedling cover. 
...
## Model Outcomes
Overall, the model estimates a distinct difference between disturbed and undisturbed forest areas. Upon investigating each individual species, this difference betwen sites can be attributed to dominant species 1. Both dominant species 2 and 3 had less weighted SLA than species 1, and the parameter estimates showed no major differences between rainforest sites.
...
In terms of ecological meaning, the model investigating shannon's index tell us that diversity does not appear to change between disturbed and pristine sites. Other factors affected diversity. It increased with higher cover of all seedlings, possibly explained by the advantages species in disturbed ecosystems utilising the expose ground and nutrients. Higher GFT tells us that diversity increased with less canopy cover which also may explain the higher dominant leaf dry weight as larger leaves utilise sunlight better. 
...
The findings of this project reveals information that can be used for protect the limestone forests. The implications to the future of limestone forests are derived in this study of seedling species in accordance to the plant cover, species richness, SLA, diversity, and temperature. 
...
# References
  ...
  3. Clements, R., Sodhi, N., Schilthuizen, M., & Ng, P. (2006). Limestone Karsts of Southeast Asia: Imperiled Arks of Biodiversity. Bioscience, 56(9), 733-742. http://dx.doi.org/10.1641/0006-3568(2006)56[733:lkosai]2.0.co;2
  4. Duguid, M., Frey, B., Ellum, D., Kelty, M., & Ashton, M. (2013). The influence of ground disturbance and gap position on understory plant diversity in upland forests of southern New England. Forest Ecology And Management, 303, 148-159. http://dx.doi.org/10.1016/j.foreco.2013.04.018
  5. Fraser, L., Pither, J., Jentsch, A., Sternberg, M., Zobel, M., Askarizadeh, D., . . . Zupo, T. (2015). Worldwide evidence of a unimodal relationship between productivity and plant species richness. Science, 349(6245), 302-305. doi:10.1126/science.aab3916
  6. Funk, J., Cleland, E., Suding, K., & Zavaleta, E. (2008). Restoration through reassembly: plant traits and invasion resistance. Trends In Ecology & Evolution, 23(12), 695-703. http://dx.doi.org/10.1016/j.tree.2008.07.013
  7. Grime, J. (1998). Benefits of plant diversity to ecosystems: immediate, filter and founder effects. Journal Of Ecology, 86(6), 902-910. http://dx.doi.org/10.1046/j.1365-2745.1998.00306.x
  8. Hillebrand, H., Burgmer, T., & Biermann, E. (2012). Running to stand still: Temperature effects on species richness, species turnover, and functional community dynamics. Marine Biology, 159(11), 2415-2422. doi:10.1007/s00227-011-1827-z
Cancel
  9. Wills, J., Herbohn, J., Moreno, M., Avela, M., & Firn, J. (2016). Next-generation tropical forests: reforestation type affects recruitment of species and functional diversity in a human-dominated landscape. Journal Of Applied Ecology, 54(3), 772-783. http://dx.doi.org/10.1111/1365-2664.12770
  ...
  12. Stevens, J., Safford, H., Harrison, S., & Latimer, A. (2015). Forest disturbance accelerates thermophilization of understory plant communities. Journal Of Ecology, 103(5), 1253-1263. http://dx.doi.org/10.1111/1365-2745.12426
  13. Wangchuk, K., Darabant, A., Rai, P., Wurzinger, M., Zollitsch, W., & Gratzer, G. (2014). Species richness, diversity and density of understory vegetation along disturbance gradients in the Himalayan conifer forest. Journal Of Mountain Science, 11(5), 1182-1191. http://dx.doi.org/10.1007/s11629-013-2942-8
