...
The three research questions require an investigation of five research variables:
...
### Exploratory Analysis
```{r, child = '050_exploratory_sla.Rmd'}
```

### Model Development
```{r, child = '051_model_sla.Rmd'}
```
...
# Model Outcomes
```{r, child = '070_allmodel_summary.Rmd'}
```
