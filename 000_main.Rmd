...
All raw data collected throughout the experiment was compiled into a single excel workbook. This data was cleaned and manipulated into five modelling datasets, for each research question.
