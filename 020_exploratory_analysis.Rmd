...
```{r}
domsla_rq1.df %>%
  ggplot(aes(x=factor(round(av_trans_elevation)), y = dom_sla_weighted_abundance, col=dom_species_id)) +
  geom_boxplot() +
  theme_project() +
  scale_colour_tableau() +
...
domsla_rq1.df %>%
  ggplot(aes(x=(round(av_trans_elevation)), y = dom_sla_weighted_abundance, col=dom_species_id)) +
  geom_point() +
  theme_project() +
  scale_colour_tableau() +
  ggtitle("Weighted SLA vs Elevation")+
