...
write.csv(domseedlingcover_rq1.df, file = paste0(data_folder, "domseedlingcover_rq1.csv"))
```
...
write.csv(domshannons_rq1.df, file = paste0(data_folder, "domshannons_rq1.csv"))
```

```{r rq1_sla}
domsla_rq1.df <- specieslvl_dom_leaf_area3 %>%
...
write.csv(domsla_rq1.df, file = paste0(data_folder, "domsla_rq1.csv"))
```
...
write.csv(hobo_rq2.df, file = paste0(data_folder, "hobo_rq2.csv"))
```
...
write.csv(species_richness_rq3.df, file = paste0(data_folder, "species_richness_rq3.csv"))
...
write.csv(species_rawabiotic_modelling.df, file = paste0(data_folder, "species_rawabiotic_modelling.csv"))
