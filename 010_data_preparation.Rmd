...
quadrat_dom_leaf_area2 <- specieslvl_dom_leaf_area2 %>%
  group_by(Site, Transect, Quadrat) %>%
...
save(hobo_modelling.df, file = paste0(data_folder, "hobo_modelling.RData"))
write.csv(hobo_modelling.df, file = paste0(data_folder, "hobo_modelling.csv"))
```
